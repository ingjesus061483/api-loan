...
<div class="card mb-4" id="cardInfoPersonal"style="display:none">    
    ...
    <div class="card-body">        
        <form autocomplete="off" action="{{url('/clients')}}"method="post">                           
            @csrf            
            @if(auth()->check())                        
            <div class="row">                
                <div  class="col-4">                    
    ...
    <div class="card mb-4" id="cardDatosContacto" style="margin:0 auto;display: none;width:50%">
        <div class="card-header">
            <i class="fas fa-table me-1"></i>
    ...
    <div class="card mb-4" id="cardInfoLaboral" style="display:none">
        ...
        <div class="card-body">
            <form autocomplete="off" action="{{url('/employmentInformations')}}"method="post">
                @csrf
    ...
    <div class="card mb-4" id="cardInfoPatrimonial" style="margin:0 auto;display: none;width:50%">        
        <div class="card-header">
            <i class="fas fa-table me-1"></i>
    ...
    <div class="card mb-4" id="cardInfoLegal" style="margin:0 auto;display: none;width:50%">
        <div class="card-header">
            <i class="fas fa-table me-1"></i>
            INFORMACION LEGAL
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7" id="divCompanySeizure" style="display: none">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="company_seizure"  id="company_seizure">     
                        </div>
                    </div>
                </div>
                <div>
